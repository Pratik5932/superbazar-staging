...
(function () {
    ...
    $.widget('quickSearch', {
            ...
            template:
                '<li class="<%- data.row_class %>" id="qs-option-<%- data.index %>" role="option">' +
					'<span class="qs-option-name">' +
                       '<div class="product"><div class="image"><a href="<%- data.link %>" title="<%- data.name %>" class="product-item-photo"><img src="<%- data.image %>" alt="<%- data.name %>" /></a></div><div class="info"> <div class="name"><a href="<%- data.link %>"><%- data.name %></a></div><div class="price"><div class="price-box price-final_price" data-role="priceBox" data-product-id="<%- data.product_id %>" ><span class="price-container price-final_price&#x20;tax&#x20;weee"><span    data-price-amount="<%- data.price %> "data-price-type="finalPrice"  class="price-wrapper "><span class="price"><%- data.price %></span></span></span></div></div></div> ' +
                    '</span>' +
        ...
        sendRequest: function () {
            ...
            return $.request.get({
                url: "https://www.superbazaar.com.au/autosearch/index/ajaxgetproduct/",
                type: 'POST',
                data: {
                    q: value
                }
                ...
                this.prepareResponse(response.body.products);
        ...
        processResponse: function () {
            ...
            $.each(this.dataset, function (index, item) {
               ...
               // dropdown.append(this.renderItem(item.html));
            }.bind(this));

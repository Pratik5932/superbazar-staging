...
*/
class Remain extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer
{
    ...
    */
    public function render(\Magento\Framework\DataObject $row)
    {
        ...
        $availQty = $StockState->getStockQty($product->getId(), $product->getStore()->getWebsiteId());
        return $availQty;

...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareColumns()
    {
		...
		$this->addColumn('quantity_and_stock_status', [
            'header'   => __('Stock Status'),
            'index'    => 'quantity_and_stock_status',
            'type'     => 'options',
            'sortable' => true,
            'filter' => false,
            'renderer' => \Magento\Sales\Block\Adminhtml\Order\Create\Search\Grid\Renderer\Stock::class,
 ...
 $this->addColumn(
            ...
            [
                ...
                'sortable' => false,
                'header' => __('Quantity'),
                'renderer' => \Magento\Sales\Block\Adminhtml\Order\Create\Search\Grid\Renderer\Remain::class,
                //'values' => 3,
                'name' => 'remain_qty',
        ...
        $attribute  = $objectManager->get('Magento\Eav\Model\Config')->getAttribute('catalog_product', 'store_location');
        $options = $attribute->getSource()->getAllOptions();
        $last_names = array_column($options, 'label', 'value');
        $this->addColumn(
            'store_location',
            [

                'header' => __('Sb-Store'),
                /*                'renderer' => \Magento\Sales\Block\Adminhtml\Order\Create\Search\Grid\Renderer\Sbstore::class,*/
                //'values' => 3,
                'name' => 'store_location',
        ...
        $this->addColumn(
            ...
            [
                ...
                'renderer' => \Magento\Sales\Block\Adminhtml\Order\Create\Search\Grid\Renderer\Pordercost::class,
                //'values' => 3,
        ...
        $this->addColumn(
            ...
            [
                ...
                'renderer' => \Magento\Sales\Block\Adminhtml\Order\Create\Search\Grid\Renderer\Nordercost::class,
                //'values' => 3,

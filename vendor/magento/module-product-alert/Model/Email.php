...
class Email extends AbstractModel
{
    ...
    public function send()
    {
		...
		#mail("testingdevcheck@gmail.com","casdad","asdsdasd");
        ...
        foreach ($products as $product) {
			$sellerproduct = $objectManager->create('Webkul\Marketplace\Model\Product')->load($product->getId(),'mageproduct_id');
            if($sellerproduct->getId()){
                $seller = $objectManager->get('Magento\Customer\Model\Customer')->load($sellerproduct->getData('seller_id'));
        ...
        $adminemailsend = $this->_transportBuilder;
        $adminemailsend->setTemplateIdentifier(
            $templateId
        )->setTemplateOptions(
            ['area' => Area::AREA_FRONTEND, 'store' => $storeId]
        )->setTemplateVars(
		...
		if(isset($sellerEmail) && $sellerEmail){
            $selleremail = $this->_transportBuilder;
            $selleremail->setTemplateIdentifier(
                $templateId
            )->setTemplateOptions(
                ['area' => Area::AREA_FRONTEND, 'store' => $storeId]
            )->setTemplateVars(

...
class Searchsuggestion extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function isOnSale($product)
    {
         ...
         #mail("er.bharatmali@gmail.com","specialPrice",print_r($product->getData(),true));
       ...
       # mail("er.bharatmali@gmail.com","regularPrice",$product->getSku()."-".$regularPrice);
       # mail("er.bharatmali@gmail.com","specialPrice",$product->getSku()."-".$specialPrice);

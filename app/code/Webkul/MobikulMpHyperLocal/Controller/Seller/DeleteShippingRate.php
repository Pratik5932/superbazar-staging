...
class DeleteShippingRate extends \Webkul\MobikulMpHyperLocal\Controller\AbstractApi  {
                ...
                if ($authData["code"] == 1)  {
                    ...
                    if ($this->_mpHelper->isSeller()) {
                        ...
                        if (count($ids)) {
                            ...
                            $returnArray["message"] = __('Ship rate deleted successfully.');
                        } else {

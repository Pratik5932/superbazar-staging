...
define([
    ...
    return Component.extend({
        defaults: {
            template: 'Webkul_SocialSignup/form/element/socialsignupAuthentication',
        },
        initialize: function () {
            var self = this;
        ...
        options: {
            twitterLogin: '#twitterlogin_authentication',
            linkedinLogin: '#linkedinlogin_authentication',
            googleLogin: '#googlelogin_authentication',
            instagramLogin: '#instagramlogin_authentication',
            fbLogin: '#fblogin_authentication',

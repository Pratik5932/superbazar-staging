    ...
    */
    public function getProductArray($productCollection, $query)
    {
        ...
        foreach ($productCollection as $item) {
           ...
           # mail("er.bharatmali@gmail.com","specialPrice",$item->getSku()."-".$price);
            #mail("er.bharatmali@gmail.com","Price",$item->getSku()."-".$specialPrice);
            ...
            if ($item->getTypeId() == "configurable") {
              ...
              #  $specialPrice = $item->getSpecialPrice();
                $specialPrice = $item->getPriceInfo()->getPrice('final_price')->getMinimalPrice()->getValue();
            } elseif (empty($price)) {
                $price = 0.0;
            }
           ...
           # mail("er.bharatmali@gmail.com","price", $specialPrice);
            ...
            */
            ...
            if($postcodeProdctPriceArray && is_array($postcodeProdctPriceArray) && !empty($postcodeProdctPriceArray)){
                ...
                if($zipCodePrice != null && !$isSalePrice){
                ...
                }else if($zipCodePrice != null && $isSalePrice){
                    $priceHelper = $objectManager->create('Magento\Framework\Pricing\Helper\Data'); 
                    $price =$priceHelper->currency($zipCodePrice, true, false);
                    # $price =$priceHelper->currency($zipCodePrice, true, false);
        ...
        }         #mail("er.bharatmali@gmail.com","productArray",print_r($productArray,true));

...
class Configurable extends \Magento\ConfigurableProduct\Block\Product\View\Type\Configurable
{
    ...
    public function getJsonConfig()
    {
        ...
        $swatchBlock           = $objectManager->create(\Webkul\MobikulApi\Block\Swatches\Configurable::class);
        ...
        $attributesData        = $objectManager->create(
            \Webkul\MobikulCore\Model\ConfigurableProduct\ConfigurableAttributeData::class
        )->getAttributesData($product, $productOptions);
        $costomizedAttr        = [];
        $customizedIndex       = [];
  ...
  #  mail("er.bharatmali@gmail.com","tets", print_r( $costomizedAttr, true ));
        ...
        $config                       = [
            ...
            "optionPrices"   => array_values($optionPrizes),
            "prices"         => [
        ...
        return $jsonHelper->jsonEncode($config);
    }

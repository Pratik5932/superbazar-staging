...
class RegextsCutoff extends \Magento\Config\Block\System\Config\Form\Field\FieldArray\AbstractFieldArray
{
    /**
    ...
    */
    ...
    {
        $this->addColumn('name', ['label' => __('Postcode'), 'style' => 'width:300px;height:200px','class' => 'textarea']);
        $this->addColumn('cut_off_time', ['label' => __('Cut Off Time'), 'style' => 'width:150px']);
        $this->addColumn('deliverydate_day_off', ['label' => __('Disable Delivery Date'), 'style' => 'width:150px']);
    ...
    */
    public function renderCellTemplate($columnName)
    {
        ...
        if($columnName == "deliverydate_day_off") {

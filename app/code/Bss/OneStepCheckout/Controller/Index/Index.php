                    ...
                    $attrName = $product->getAttributeText('store_location');
                     $storeLocation =  $product->getAttributeText('store_location');
                        ...
                        if (!in_array($profilePostCode, $postCodes)) {
                         $this->messageManager->addErrorMessage("Profile post code is ". $profilePostCode ." and some of your items in cart is for other postcode. Please clear the shopping cart and shop again.");
                        return $this->resultRedirectFactory->create()->setPath('checkout/cart');

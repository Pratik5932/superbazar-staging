...
namespace Superbazaar\General\Controller\Adminhtml\Product\Initialization\Helper\Plugin;
...
class Configurable extends  \Magento\ConfigurableProduct\Controller\Adminhtml\Product\Initialization\Helper\Plugin\Configurable
{
    /**
        ...
        if (isset($configurableMatrix) && $configurableMatrix != "") {
            ...
            foreach ($configurableMatrix as $item) {
                if (isset($item['newProduct']) && $item['newProduct']) {
                    ...
                    $result[$item['variationKey']]['product_has_weight'] = 0.1;
                    $result[$item['variationKey']]['weight'] = 0.1;
                }
            }
        }

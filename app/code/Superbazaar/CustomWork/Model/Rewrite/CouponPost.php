 ...
 */
namespace Superbazaar\CustomWork\Model\Rewrite;
    ...
    public function execute()
    {
        ...
        try {
            ...
            if ($codeLength) {
				...
				$couponCodeValue = $this->_scopeConfig->getValue(
					'general/settings/coupon_code',
					\Magento\Store\Model\ScopeInterface::SCOPE_STORE
				);
				$customSuccessMessage = $this->_scopeConfig->getValue(
                    ...
                    if ($isCodeLengthValid && $coupon->getId()) {
						...
						if ($enable && $couponCodeValue == $couponCode) {
							$this->messageManager->addSuccessMessage(
								__($escaper->escapeHtml($customSuccessMessage))
							);
						} else {
							$this->messageManager->addSuccessMessage(
								__(

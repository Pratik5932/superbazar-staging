<?php
namespace Orbs\OutStockLast\Plugin\Product\ProductList;
...
class Toolbar
{
     ...
     * @return array
     */
    public function beforeLoad(\Magento\CatalogSearch\Model\ResourceModel\Fulltext\Collection $subject, $printQuery = false, $logQuery 
= false)
    {

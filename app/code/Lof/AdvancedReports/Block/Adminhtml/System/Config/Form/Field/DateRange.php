...
protected function initScripts($options = array()) {
  ...
  if(!$startDate) {
    $startDate = 'moment().subtract(29, "days")';
          ...
          $tmp_obj = Date($tmp);
          $startDateString = 'var $startDateString ="'.\DateTime::createFromFormat('MMMM dd, yyyy',$tmp_obj).'";';
        ...
        if(!$endDate) {
          ...
          $tmp_obj = Date($tmp);
          $endDateString = 'var $endDateString ="'.\DateTime::createFromFormat('MMMM dd, yyyy',$tmp_obj).'";';

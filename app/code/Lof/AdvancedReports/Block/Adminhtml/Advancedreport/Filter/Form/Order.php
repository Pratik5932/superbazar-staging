    ...
    protected function _prepareForm()
    {
       ...
       $values = array();
        ...
        if($filter_from && $filter_to) {  
            ...
            $filter_from_obj = Date(strtotime($filter_from));
            $filter_to_obj = Date(strtotime($filter_to));

            // $filter_from = $filter_from_obj->toString('MMMM dd, yyyy');
            // $filter_to = $filter_to_obj->toString('MMMM dd, yyyy');
            $filter_from = \DateTime::createFromFormat('MMMM dd, yyyy', $filter_from_obj);
            $filter_to =\DateTime::createFromFormat('MMMM dd, yyyy',$filter_to_obj);

...
$this->addColumn('cost', array(
 ...
 $product = $this->_objectManager->get('Magento\Framework\Registry')->registry('current_product');//get current product
   // echo $product->getId();
// $attribute = $this->_objectManager->create('\Magento\Eav\Model\Config')->getAttribute('catalog_product', 'brand');
// $options = $attribute->getSource()->getAllOptions();
// $options_value = array();
// foreach( $options as $option ) {
// //   $options_value[] = $option['value'];
//    $options_value[] = $option['label'];
// //echo'<pre>';print_r($options_value);
// }
//die;

    ...
    */
    ...
    { 
        ...
        $this->addColumn('total_cost_amount', [
            'header'            => __('Actual Order Cost'),
            'currency_code'     => $currencyCode,
            'index'             => 'total_cost_amount',
            'total'             => 'sum',
            'rate'              => $rate,
            'filter'    => false,
            'renderer'  => 'Lof\AdvancedReports\Block\Adminhtml\Grid\Column\Renderer\Cost'
        ...
        $this->addColumn('total_profit_amount', [
            ...
            'rate'          => $rate,
            'filter'    => false,
            'renderer'  => 'Lof\AdvancedReports\Block\Adminhtml\Grid\Column\Renderer\Profit'

...
class Topcustomers extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Customer
{
    /**
    ...
    {    
        ...
        $this->_initAction()->_setActiveMenu(
            'Lof_AdvancedReports::topcustomers'
        )->_addBreadcrumb(
            __('Top Customer Report'),
            __('Top Customer Report')
        );
        $this->_registry->register('report_type', "topcustomers"); 
        $this->_registry->register('header_text', __("Top Customer Report"));
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Top Customer Report'));   
        
        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_customer_topcustomers.grid');  
        $filterFormBlock = $this->_view->getLayout()->getBlock('grid.filter.form');
        $this->_initReportAction([$gridBlock, $filterFormBlock], 'topcustomers'); 

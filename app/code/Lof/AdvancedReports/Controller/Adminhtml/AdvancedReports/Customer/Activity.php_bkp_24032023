...
class Activity extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Customer
{
    /**
    ...
    {     
        $this->_initAction()->_setActiveMenu(
            'Lof_AdvancedReports::customeractivity'
        )->_addBreadcrumb(
            __('Customer Activity'),
            __('Customer Activity')
        );
        $this->_registry->register('report_type', "activity"); 
        $this->_registry->register('header_text', __("Customer Activity"));
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Customer Activity Report'));   
        $chartBlock = $this->_view->getLayout()->getBlock('report.chart');
        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_customer_activity.grid');  
        $filterFormBlock = $this->_view->getLayout()->getBlock('grid.filter.form');
        $this->_initReportAction([$gridBlock, $filterFormBlock,$chartBlock], 'activity'); 

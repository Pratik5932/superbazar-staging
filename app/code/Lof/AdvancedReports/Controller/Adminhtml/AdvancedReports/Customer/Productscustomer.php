...
class Productscustomer extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Customer
{
    /**
    ...
    {    
        ...
        $this->_initAction()->_setActiveMenu(
            'Lof_AdvancedReports::productscustomer'
        )->_addBreadcrumb(
            __('Products Customer Report'),
            __('Products Customer Report')
        );
        $this->_registry->register('report_type', "productscustomer"); 
        $this->_registry->register('header_text', __("Products Customer Report"));
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Products Customer Report'));   
        
        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_customer_productscustomer.grid');  
        $filterFormBlock = $this->_view->getLayout()->getBlock('grid.filter.form');
        $this->_initReportAction([$gridBlock, $filterFormBlock], 'productscustomer'); 
    ...
    protected function _isAllowed()
    {
     ...
     /* if (!$this->getData('is_valid') && !$this->getData('local_valid')) {
        ...
        return $this->_authorization->isAllowed('Lof_AdvancedReports::topcustomers');
    }

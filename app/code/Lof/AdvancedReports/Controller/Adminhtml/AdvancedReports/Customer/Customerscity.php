...
class Customerscity extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Customer
{
    /**
    ...
    {    
        ...
        $this->_initAction()->_setActiveMenu(
            'Lof_AdvancedReports::customerscity'
        )->_addBreadcrumb(
            __('Customers by City'),
            __('Customers by City')
        );
        $this->_registry->register('report_type', "customerscity"); 
        $this->_registry->register('header_text', __("Customers by City"));
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Customers by City'));   
        
        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_customer_customerscity.grid');  
        $filterFormBlock = $this->_view->getLayout()->getBlock('grid.filter.form');
        $this->_initReportAction([$gridBlock, $filterFormBlock], 'customerscity'); 

...
class Productsconfiguration extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Products
{
    /**
    ...
    {    
        ...
        $this->_initAction()->_setActiveMenu(
            'Lof_AdvancedReports::productsreport'
        )->_addBreadcrumb(
            __('Products Configuration Report'),
            __('Products Configuration Report')
        );
        $this->_registry->register('report_type', "productsconfiguration"); 
        $this->_registry->register('header_text', __("Products Configuration Report"));
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Products Configuration Report'));   
        
        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_products_productsconfiguration.grid');   
        $filterFormBlock = $this->_view->getLayout()->getBlock('grid.filter.form');
        $this->_initReportAction([$gridBlock, $filterFormBlock], 'productsconfiguration'); 
    ...
    protected function _isAllowed()
    {
       ...
       /* if (!$this->getData('is_valid') && !$this->getData('local_valid')) {
        ...
        return $this->_authorization->isAllowed('Lof_AdvancedReports::productsreport');
    } 

...
class Productsreport extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Products
{
    /**
    ...
    {    
        ...
        $this->_registry->register('report_type', "productsreport"); 
        $this->_registry->register('header_text', __("Products Report"));
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Products Report'));   
        
        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_products_productsreport.grid');   
        $filterFormBlock = $this->_view->getLayout()->getBlock('grid.filter.form');
        $this->_initReportAction([$gridBlock, $filterFormBlock], 'productsreport'); 

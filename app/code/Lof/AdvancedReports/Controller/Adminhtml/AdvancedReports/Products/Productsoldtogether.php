...
class Productsoldtogether extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Products
{
    /**
    ...
    {    
        ...
        $this->_initAction()->_setActiveMenu(
            'Lof_AdvancedReports::productsoldtogether'
        )->_addBreadcrumb(
            __('Products most frequently being purchased together'),
            __('Products most frequently being purchased together')
        );
        $this->_registry->register('report_type', "productsoldtogether"); 
        $this->_registry->register('header_text', __("Products most frequently being purchased together"));
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Products most frequently being purchased together'));   
        
        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_products_productsoldtogether.grid');  
        $filterFormBlock = $this->_view->getLayout()->getBlock('grid.filter.form');
        $this->_initReportAction([$gridBlock, $filterFormBlock], 'productsoldtogether'); 

...
class Productsnotsold extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Products
{
    /**
    ...
    {    
        ...
        $this->_initAction()->_setActiveMenu(
            'Lof_AdvancedReports::productsnotsold'
        )->_addBreadcrumb(
            __('Products Not Sold'),
            __('Products Not Sold')
        );
        $this->_registry->register('report_type', "productsnotsold"); 
        $this->_registry->register('header_text', __("Products Not Sold"));
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Products Not Sold'));   
        
        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_products_productsnotsold.grid');  
        $filterFormBlock = $this->_view->getLayout()->getBlock('grid.filter.form');
        $this->_initReportAction([$gridBlock, $filterFormBlock], 'productsnotsold'); 

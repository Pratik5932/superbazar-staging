...
class Dayofweek extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Sales
{
    /**
    ...
    {    
        ...
        $this->_initAction()->_setActiveMenu(
            'Lof_AdvancedReports::salesbydayofweek'
        )->_addBreadcrumb(
            __('Sales By Day Of Week'),
            __('Sales By Day Of Week')
        );
        $this->_registry->register('report_type', "dayofweek"); 
        $this->_registry->register('header_text', __("Sales By Day Of Week"));
        ...
        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_sales_dayofweek.grid');  
        $filterFormBlock = $this->_view->getLayout()->getBlock('grid.filter.form');
        $this->_initReportAction([$gridBlock, $filterFormBlock,$chartBlock], 'dayofweek'); 
    ...
    protected function _isAllowed()
    {
       ...
       /* if (!$this->getData('is_valid') && !$this->getData('local_valid')) {
        ...
        return $this->_authorization->isAllowed('Lof_AdvancedReports::salesbydayofweeks');
    } 

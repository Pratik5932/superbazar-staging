...
class Paymenttype extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Sales
{
    /**
    ...
    {    
        ...
        $this->_initAction()->_setActiveMenu(
            'Lof_AdvancedReports::salesbypaymenttype'
        )->_addBreadcrumb(
            __('Sales By Payment Type'),
            __('Sales By Payment Type')
        );
        $this->_registry->register('report_type', "paymenttype"); 
        $this->_registry->register('header_text', __("Sales By Payment Type"));
        ...
        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_sales_paymenttype.grid');  
        $filterFormBlock = $this->_view->getLayout()->getBlock('grid.filter.form');
        $this->_initReportAction([$gridBlock, $filterFormBlock,$chartBlock], 'paymenttype'); 
    ...
    protected function _isAllowed()
    {
       ...
       /* if (!$this->getData('is_valid') && !$this->getData('local_valid')) {
        ...
        return $this->_authorization->isAllowed('Lof_AdvancedReports::salesbypaymenttype');
    } 

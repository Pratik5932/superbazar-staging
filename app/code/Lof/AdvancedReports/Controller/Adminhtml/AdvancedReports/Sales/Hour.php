...
class Hour extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Sales
{
    /**
    ...
    {    
        ...
        $this->_initAction()->_setActiveMenu(
            'Lof_AdvancedReports::salesbyhour'
        )->_addBreadcrumb(
            __('Sales By Hour'),
            __('Sales By Hour')
        );
        $this->_registry->register('report_type', "hour"); 
        $this->_registry->register('header_text', __("Sales By Hour"));
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Sales By Hour'));   
        $chartBlock = $this->_view->getLayout()->getBlock('report.chart');
        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_sales_hour.grid');  
        $filterFormBlock = $this->_view->getLayout()->getBlock('grid.filter.form');
        $this->_initReportAction([$gridBlock, $filterFormBlock,$chartBlock], 'hour'); 
    ...
    protected function _isAllowed()
    {
        ...
        return $this->_authorization->isAllowed('Lof_AdvancedReports::salesbyhour');
    } 

...
class Category extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Sales
{
    /**
    ...
    {    
        ...
        $this->_initAction()->_setActiveMenu(
            'Lof_AdvancedReports::salesbycategory'
        )->_addBreadcrumb(
            __('Sales Category'),
            __('Sales Category')
        );
        $this->_registry->register('report_type', "category"); 
        $this->_registry->register('header_text', __("Sales Category"));
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Sales Category'));   
        
        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_sales_category.grid');  
        $filterFormBlock = $this->_view->getLayout()->getBlock('grid.filter.form');
        $this->_initReportAction([$gridBlock, $filterFormBlock], 'category'); 
    ...
    protected function _isAllowed()
    {
       ...
       /* if (!$this->getData('is_valid') && !$this->getData('local_valid')) {
        ...
        return $this->_authorization->isAllowed('Lof_AdvancedReports::salesbycategory');
    } 

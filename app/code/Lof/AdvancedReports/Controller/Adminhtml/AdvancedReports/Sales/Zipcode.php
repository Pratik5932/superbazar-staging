...
class Zipcode extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Sales
{
    /**
    ...
    {    
        ...
        $this->_initAction()->_setActiveMenu(
            'Lof_AdvancedReports::salesbyzipcode'
        )->_addBreadcrumb(
            __('Sales By Zipcode'),
            __('Sales By Zipcode')
        );
        $this->_registry->register('report_type', "zipcode"); 
        $this->_registry->register('header_text', __("Sales By Zipcode"));
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Sales By Zipcode'));   
        
        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_sales_zipcode.grid');  
        $filterFormBlock = $this->_view->getLayout()->getBlock('grid.filter.form');
        $this->_initReportAction([$gridBlock, $filterFormBlock], 'zipcode'); 
    ...
    protected function _isAllowed()
    {
       ...
       /* if (!$this->getData('is_valid') && !$this->getData('local_valid')) {
        ...
        return $this->_authorization->isAllowed('Lof_AdvancedReports::salesbyzipcode');
    }  

...
class Region extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Sales
{
    /**
    ...
    {    
        ...
        $this->_initAction()->_setActiveMenu(
            'Lof_AdvancedReports::salesbyregion'
        )->_addBreadcrumb(
            __('Sales By Region/ State'),
            __('Sales By Region/ State')
        );
        $this->_registry->register('report_type', "region"); 
        $this->_registry->register('header_text', __("Sales By Region/ State"));
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Sales By Region/ State'));   
        
        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_sales_region.grid');  
        $filterFormBlock = $this->_view->getLayout()->getBlock('grid.filter.form');
        $this->_initReportAction([$gridBlock, $filterFormBlock], 'region'); 
    ...
    protected function _isAllowed()
    {
        ...
        return $this->_authorization->isAllowed('Lof_AdvancedReports::salesbyregion');
    } 

...
class Producttype extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Sales
{
    /**
    ...
    {     
        $this->_initAction()->_setActiveMenu(
            'Lof_AdvancedReports::salesbyproducttype'
        )->_addBreadcrumb(
            __('Sales Product Type'),
            __('Sales Product Type')
        );
        $this->_registry->register('report_type', "producttype"); 
        $this->_registry->register('header_text', __("Sales Product Type"));
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Sales Product Type'));   
        $chartBlock = $this->_view->getLayout()->getBlock('report.chart');
        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_sales_producttype.grid');  
        $filterFormBlock = $this->_view->getLayout()->getBlock('grid.filter.form');
        $this->_initReportAction([$gridBlock, $filterFormBlock,$chartBlock], 'producttype'); 
    ...
    protected function _isAllowed()
    {
        ...
        return $this->_authorization->isAllowed('Lof_AdvancedReports::salesbyproducttype');
    } 

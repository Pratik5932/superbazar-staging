...
class Product extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Sales
{
    /**
    ...
    {    
        ...
        $this->_initAction()->_setActiveMenu(
            'Lof_AdvancedReports::salesbyproduct'
        )->_addBreadcrumb(
            __('Sales Product'),
            __('Sales Product')
        );
        $this->_registry->register('report_type', "product"); 
        $this->_registry->register('header_text', __("Sales Product"));
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Sales Product'));   
        $chartBlock = $this->_view->getLayout()->getBlock('report.chart');
        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_sales_product.grid');  
        $filterFormBlock = $this->_view->getLayout()->getBlock('grid.filter.form');
        $this->_initReportAction([$gridBlock, $filterFormBlock,$chartBlock], 'product'); 
    ...
    protected function _isAllowed()
    {
        ...
        return $this->_authorization->isAllowed('Lof_AdvancedReports::salesbyproduct');
    } 

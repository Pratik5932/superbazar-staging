...
class Country extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Sales
{
    /**
    ...
    {    
        ...
        $this->_initAction()->_setActiveMenu(
            'Lof_AdvancedReports::salesbycountry'
        )->_addBreadcrumb(
            __('Sales Country'),
            __('Sales Country')
        );
        $this->_registry->register('report_type', "country"); 
        $this->_registry->register('header_text', __("Sales Country"));
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Sales Country'));   
        
        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_sales_country.grid');  
        $filterFormBlock = $this->_view->getLayout()->getBlock('grid.filter.form');
        $this->_initReportAction([$gridBlock, $filterFormBlock], 'country'); 
    ...
    protected function _isAllowed()
    {
        ...
        return $this->_authorization->isAllowed('Lof_AdvancedReports::salesbycountry');
    } 

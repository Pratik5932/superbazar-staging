...
class Productcountry extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Sales
{
    /**
    ...
    {    
        ...
        $this->_initAction()->_setActiveMenu(
            'Lof_AdvancedReports::salesproductcountry'
        )->_addBreadcrumb(
            __('Sales Per Product Per Country'),
            __('Sales Per Product Per Country')
        );
        $this->_registry->register('report_type', "productcountry"); 
        $this->_registry->register('header_text', __("Per Product Per Country'"));
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Per Product Per Country'));   
        
        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_sales_productcountry.grid');  
        $filterFormBlock = $this->_view->getLayout()->getBlock('grid.filter.form');
        $this->_initReportAction([$gridBlock, $filterFormBlock], 'productcountry'); 
    ...
    protected function _isAllowed()
    {
        ...
        return $this->_authorization->isAllowed('Lof_AdvancedReports::salesproductcountry');
    }  

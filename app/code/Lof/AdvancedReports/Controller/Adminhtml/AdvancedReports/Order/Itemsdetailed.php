...
class Itemsdetailed extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Order
{
    /**
    ...
    {    
        ...
        $this->_initAction()->_setActiveMenu(
            'Lof_AdvancedReports::orderitemsdetailed'
        )->_addBreadcrumb(
            __('Order Items Detailed'),
            __('Order Items Detailed')
        );
        $this->_registry->register('report_type', "itemsdetailed"); 
        $this->_registry->register('header_text', __("Orders Items Detailed"));
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Order Items Detailed Report'));   
        
        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_order_itemsdetailed.grid');  
        $filterFormBlock = $this->_view->getLayout()->getBlock('grid.filter.form');
        $this->_initReportAction([$gridBlock, $filterFormBlock], 'itemsdetailed'); 
    ...
    protected function _isAllowed()
    {
        ...
        return $this->_authorization->isAllowed('Lof_AdvancedReports::orderitemsdetailed');
    } 

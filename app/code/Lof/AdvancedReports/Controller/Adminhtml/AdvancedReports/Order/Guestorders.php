...
class Guestorders extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Order
{
    /**
    ...
    {    
        ...
        $this->_initAction()->_setActiveMenu(
            'Lof_AdvancedReports::guestorders'
        )->_addBreadcrumb(
            __('Order Items Detailed'),
            __('Order Items Detailed')
        );
        $this->_registry->register('report_type', "guestorders"); 
        $this->_registry->register('header_text', __("Orders By Guests"));
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Order By Guests Report'));   
        
        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_order_guestorders.grid');  
        $filterFormBlock = $this->_view->getLayout()->getBlock('grid.filter.form');
        $this->_initReportAction([$gridBlock, $filterFormBlock], 'guestorders'); 
    ...
    protected function _isAllowed()
    {
      ...
      /*if (!$this->getData('is_valid') && !$this->getData('local_valid')) {
        ...
        return $this->_authorization->isAllowed('Lof_AdvancedReports::guestorders');
    } 

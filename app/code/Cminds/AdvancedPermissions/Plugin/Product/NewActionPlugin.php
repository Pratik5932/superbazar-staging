...
class NewActionPlugin extends AbstractPlugin
{
    ...
    /**
     * @param \Magento\Catalog\Controller\Adminhtml\Product\NewAction $subject
     * @param $proceed
     *
     * @return mixed
     */
    public function aroundExecute(\Magento\Catalog\Controller\Adminhtml\Product\NewAction $subject, $proceed)
    {
        ...
        return $this->redirectBack(
            self::REDIRECT_PATH,
            __('You do not have permission to create product.')
        );
    }
}

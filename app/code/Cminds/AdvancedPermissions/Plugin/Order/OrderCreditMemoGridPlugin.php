...
/**
 * Class OrderCreditMemoGridPlugin
 *
 * @package Cminds\AdvancedPermissions\Plugin\Order
 */
class OrderCreditMemoGridPlugin extends AbstractPlugin
{
    /**
    ...
    /**
     * OrderCreditMemoGridPlugin constructor.
     *
     ...
     * @return mixed
     */
    public function aroundGetItems(\Magento\Sales\Model\ResourceModel\Order\Creditmemo\Grid\Collection $subject, callable $proceed)
    {

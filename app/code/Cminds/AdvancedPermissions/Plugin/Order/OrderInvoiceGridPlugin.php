...
/**
 * Class OrderInvoiceGridPlugin
 *
 * @package Cminds\AdvancedPermissions\Plugin\Order
 */
class OrderInvoiceGridPlugin extends AbstractPlugin
{
    /**
    ...
    /**
     * OrderInvoiceGridPlugin constructor.
     *
    ...
    /**
     * Filter order invoice grid.
     *
     * @param \Magento\Sales\Model\ResourceModel\Order\Invoice\Grid\Collection $subject
     * @param callable $proceed
     *
     * @return mixed
     */
    public function aroundGetItems(\Magento\Sales\Model\ResourceModel\Order\Invoice\Grid\Collection $subject, callable $proceed)
    {

...
/**
 * Class StoreDashboardPlugin
 *
 * @package Cminds\AdvancedPermissions\Plugin\Store
 */
class StoreDashboardPlugin extends AbstractPlugin
{
    /**
    ...
    /**
     * StoreDashboardPlugin constructor.
     *
    ...
    /**
     * Filter dashboard statistic according to allowed stores views.
     *
     ...
     * @return mixed
     */
    public function aroundLoad(\Magento\Sales\Model\ResourceModel\Order\Collection $subject, callable $proceed)
    {

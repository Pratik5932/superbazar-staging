...
/**
 * Class MassUnsubscribePlugin
 *
 * @package Cminds\AdvancedPermissions\Plugin\Customer
 */
class MassUnsubscribePlugin extends AbstractPlugin
{
    /**
     *
     */
    ...
    /**
     * @param \Magento\Customer\Controller\Adminhtml\Index\MassUnsubscribe $subject
     * @param $proceed
     *
     * @return mixed
     */
    public function aroundExecute(\Magento\Customer\Controller\Adminhtml\Index\MassUnsubscribe $subject, $proceed)
    {

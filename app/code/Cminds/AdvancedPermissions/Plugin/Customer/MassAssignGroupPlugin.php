...
/**
 * Class MassAssignGroupPlugin
 *
 * @package Cminds\AdvancedPermissions\Plugin\Customer
 */
class MassAssignGroupPlugin extends AbstractPlugin
{
    /**
     *
     */
    ...
    /**
     * @param \Magento\Customer\Controller\Adminhtml\Index\MassAssignGroup $subject
     * @param $proceed
     *
     * @return mixed
     */
    public function aroundExecute(\Magento\Customer\Controller\Adminhtml\Index\MassAssignGroup $subject, $proceed)
    {

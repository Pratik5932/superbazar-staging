...
class MassDeletePlugin extends AbstractPlugin
{
    ...
    /**
     * @param \Magento\Customer\Controller\Adminhtml\Index\MassDelete $subject
     * @param $proceed
     *
     * @return mixed
     */
    public function aroundExecute(\Magento\Customer\Controller\Adminhtml\Index\MassDelete $subject, $proceed)
    {

define([
    ...
    $.widget('mage.SwatchRenderer', {
        ...
        _LoadProductMedia: function () {
            ...
            productId = $this.parents('.cart-add-promo-product-item-info')
        ...
        updateBaseImage: function (images, context, isProductViewExist) {
            ...
            if (isProductViewExist) {
                ...
                try{
                    $(this.element).closest('.cart-add-promo-product-item-info')
                        .find('.cart-add-promo-product-image').attr('src', justAnImage.img);
                }catch(err) {
                }

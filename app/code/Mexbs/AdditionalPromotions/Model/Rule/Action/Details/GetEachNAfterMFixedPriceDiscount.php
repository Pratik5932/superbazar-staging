...
class GetEachNAfterMFixedPriceDiscount extends \Mexbs\AdditionalPromotions\Model\Rule\Action\Details\GetEachNAbstract{

    const SIMPLE_ACTION = 'get_each_n_after_m_fixed_price_discount_action';
    protected $type = 'Mexbs\AdditionalPromotions\Model\Rule\Action\Details\GetEachNAfterMFixedPriceDiscount';
    ...
    public function asHtmlRecursive()
    {
        ...
        $getEachNHtml .=  __(
                "Get the subsequent %1 items (matching the same conditions) (ordered by %2), for %3%4, after %5 such items has been added to cart for full price",

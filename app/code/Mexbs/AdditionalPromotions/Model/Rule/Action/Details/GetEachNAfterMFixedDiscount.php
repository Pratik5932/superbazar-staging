...
class GetEachNAfterMFixedDiscount extends \Mexbs\AdditionalPromotions\Model\Rule\Action\Details\GetEachNAbstract{

    const SIMPLE_ACTION = 'get_each_n_after_m_fixed_discount_action';
    protected $type = 'Mexbs\AdditionalPromotions\Model\Rule\Action\Details\GetEachNAfterMFixedDiscount';
    ...
    public function asHtmlRecursive()
    {
        ...
        $getEachNHtml .=  __(
                "Get the subsequent %1 items (matching the same conditions) (ordered by %2), with %3%4 discount, after %5 such items has been added to cart for full price",

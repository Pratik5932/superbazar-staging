...
class GetAllAfterMPercentDiscount extends \Mexbs\AdditionalPromotions\Model\Rule\Action\Details\GetEachNAbstract{

    const SIMPLE_ACTION = 'get_all_after_m_percent_discount_action';
    protected $type = 'Mexbs\AdditionalPromotions\Model\Rule\Action\Details\GetAllAfterMPercentDiscount';
    ...
    public function asHtmlRecursive()
    {
        ...
        $getEachNHtml .=  __(
                "With %1% discount, after %2 such items has been added to cart for full price",

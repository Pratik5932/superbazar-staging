                                ...
                                if (address.val()) {
                                    ...
                                    if(zipcode_cookie){
                                        if(zipcode_cookie == address.val())
                                        {
                                         ...
                                         window.location.href = "https://magento-952359-3631221.cloudwaysapps.com//";                                   
                                        }
                                        else{
                                            ...
                                            success: function (response) {
                                              //  var response = $.parseJSON(transport);
                                                if (response.status ==1) {
													...
													alert('We are currently supplying only in '+response.ids+',  if your Melbourne Post code not in the list, kindly reach out info@superbazaar.com.au to update it');
...
//console.log(postcodeArray.includes(optionsData.storeLocation));
                    ...
                    if(optionsData.storeLocation !="" && postcodeArray.length > 0 && postcodeArray.includes(optionsData.currentLocation) == false && optionsData.isAddressSet == 1){
                        $.cookies.set('storeLocation', optionsData.storeLocation);
                        $.cookies.set('currentLocation', optionsData.currentLocation);
                        window.location.href = "https://www.superbazaar.com.au/";
                    ...
                    if($.cookies.get('storeLocation')  && postcodeArray.includes(optionsData.currentLocation) < 0 && !optionsData.isProduct && optionsData.isAddressSet == 1){
                        $(".select-address-popup").modal({
